 ...
 * @version 1.00
 * 
 * Diálogo de configuração da impressão do Relatório de Focos
 * 
 */
...
public class RelatorioFocoUI extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RelatorioFocoUI frame = new RelatorioFocoUI();
	 ...
	 * Create the frame.
	 */
	public RelatorioFocoUI() {
		setClosable(true);
		setBounds(100, 100, 552, 238);
		JPanel panel = new JPanel();
		panel.setBorder(new TitledBorder(null, "Relatório Focos", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		JRadioButton rdbtnFocosPeriodo = new JRadioButton("Foco no periodo");
		...
		jbImprimir.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					JasperPrint jp =  JasperFillManager.fillReport("/home/wagmattei/git/Projeto-Interador-Eugned/Eugned2/src/view/RelatorioFocos.jasper", hm,ConnectionUtil.getConnection());
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel.createSequentialGroup()
							...
							.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
								...
								.addComponent(rdbtnFocosPeriodo)))
						.addGroup(gl_panel.createSequentialGroup()
							.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panel.createSequentialGroup()
									.addGap(31)
